  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px", fontFamily: "Heebo, sans-serif" }}>
      ...
      {showAccountantsTable && (
        <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "10px", overflow: "hidden" }}>
          ...
          <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch", width: "100%" }}>
            <table style={{ width: "100%", minWidth: "500px", borderCollapse: "collapse", fontSize: "12px", tableLayout: "fixed" }}>
              <thead>
      ...
      <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: "10px", overflow: "hidden" }}>
        ...
        <div style={{ overflowX: "auto", WebkitOverflowScrolling: "touch", width: "100%" }}>
          <table style={{ width: "100%", minWidth: "800px", borderCollapse: "collapse", fontSize: "11px", tableLayout: "fixed" }}>
            <thead>
              <tr style={{ background: "#f8fafc", textAlign: "right" }}>
