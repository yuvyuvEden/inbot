...
export const SignupEmail = ({ confirmationUrl }: SignupEmailProps) => (
  <Html lang="he" dir="rtl">
    <Head />
    <Preview>אימות כתובת המייל — INBOT</Preview>
    <Body style={main}>
      <Container style={container}>
        <Section style={card}>
          ...
          <Section style={bodySection}>
            <Heading style={h1}>אימות כתובת המייל</Heading>
            <Text style={text}>
              תודה שנרשמת ל-INBOT! לחץ על הכפתור למטה כדי לאמת את כתובת המייל שלך.
            </Text>
            ...
            <Text style={footerNote}>
              אם לא נרשמת ל-INBOT — התעלם ממייל זה.
            </Text>
          </Section>
